...
class ExtractProgramData
{
    ...
    private $extracted_programs = [];

    private function requestDOM($url)
    {
        $ch = curl_init();
    ...
    public function extractData($count)
    {
        ...
        for ($i = 0; $i < $count; $i++) {
            ...
            $this->extracted_programs[] = $program;
        }
    }
    ...
    public function getExtractedPrograms()
    {
        ...
        return $this->extracted_programs;
    }
}
